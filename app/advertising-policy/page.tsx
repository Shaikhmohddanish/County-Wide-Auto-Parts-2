          ...
          <div className="max-w-4xl mx-auto mt-8">
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <div className="prose max-w-none">
                ...
                <p className="mb-6">
                  At County Wide Auto Parts ("we", "our", "us"), located at https://www.countywideautoparts.com/, we are committed to 
                ...
                <div className="mb-8">
                  ...
                  <p className="mb-4">
                    Some pages or links on https://www.countywideautoparts.com/ may include affiliate links. This means we may earn 
