          ...
          <div className="max-w-4xl mx-auto mt-8">
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <div className="prose max-w-none">
                ...
                <p className="mb-6">
                  At County wide auto parts ("we", "our", "us"), accessible from https://www.countywideautoparts.com/, we value your privacy. 
                ...
                <div className="mb-8">
                  ...
                  <p className="mb-4">
                    To exercise any of these rights, please contact us at support@countywideautoparts.com.
                  </p>
                </div>
                ...
                <div className="mb-8">
                  ...
                  <p className="mb-4">
                    ...
                    <br />
                    Email: support@countywideautoparts.com
                    <br />
                    Phone: 888 789-8397
                    <br />
                    Address: 127 Willets Point Blvd Corona, NY 11368
                    <br />
                    Website: https://www.countywideautoparts.com/
                  </p>
                </div>
              </div>
            </div>
